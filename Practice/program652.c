...
//  Description :       It is used to Display all details all files
//  Input :             None
//  Output :            None
//  Author :            Tushar Vijay Shilimkar
//  Date :              02/08/2026
...
//  Description :       It is used to delete the Specific files
//  Input :             File Name
//  Output :            Exit status of the function
//  Author :            Tushar Vijay Shilimkar
//  Date :              02/08/2026
                ...
                )
{
    ...
    for(i = 0; i < MAXOPENFILES; i++)
    {
        if(uareaobj.UFDT[i] != NULL)
        {
            if(strcpy(uareaobj.UFDT[i]->ptrinode->FileName,name) == 0)
            {
...
//  Description :       It is used to write the data into Specific files
...
int write_file(
                    ...
                    char *data,     // Address of data block
...
//  Description :       It is used to read the data from Specific files
//  Input :             File Descriptor
    ...
    while(1)
    {
        ...
        else if(iCount == 3)
        {
            ...
            if(strcmp(Command[0], "creat") == 0)
            {
                ...
                {
                    printf("Error : Unable to create new file\n");
                    printf("Because the file name already present\n");
